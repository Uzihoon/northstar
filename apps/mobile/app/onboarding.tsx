    ...
    <Screen scroll={false}>
      ...
      >
        <View style={styles.topCard}>
          <Pill label="Nori onboarding" tone="sage" />
          <Text style={styles.title}>Let's make future trips feel less generic.</Text>
          <Text style={styles.subtitle}>
            Chat naturally. Nori extracts preferences quietly, and you can skip any time.
          </Text>
          <PrimaryButton
        ...
        >
          ...
          {isComplete ? (
            <View style={styles.completeCard}>
              <Text style={styles.completeTitle}>Nori has enough to start.</Text>
              <Text style={styles.completeBody}>
                We'll use this preference profile when you choose a destination.
              </Text>
